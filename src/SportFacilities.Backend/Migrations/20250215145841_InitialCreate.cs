...
namespace SportFacilities.Backend.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SportFacilityId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilityAvailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FacilityAvailabilities_SportFacilities_SportFacilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_SportFacilities_SportFacilityId",
                        column: x => x.SportFacilityId,
                        principalTable: "SportFacilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityAvailabilities_SportFacilityId",
                table: "FacilityAvailabilities",
                column: "SportFacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_SportFacilityId",
                table: "Reservations",
                column: "SportFacilityId");
